...
let chinaPopulation = percentageOfWorld1(1,440);
let israelPopulation = percentageOfWorld1(9,364);
let unitedKingdomPopulation = percentageOfWorld1(67,330);

console.log("China has 1.412 billion  people, so it\'s about" + " " + chinaPopulation * 100 + " " + "% of the world population.");
...
let chinaPopulation2 = percentageOfWorld2(1,440);
let israelPopulation2 = percentageOfWorld2(9,364);
let unitedKingdomPopulation2 = percentageOfWorld2(67,330);
console.log("China has 1.412 billion  people, so it\'s about" + " " + chinaPopulation2 * 100 + " " + "% of the world population.");
